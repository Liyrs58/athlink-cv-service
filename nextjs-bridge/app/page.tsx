  ...
  return (
    <main className="min-h-screen">
      ...
      <section className="relative pt-32 pb-20 px-6 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-[#00d4aa]/[0.03] rounded-full blur-[100px] pointer-events-none" />
            ...
            {[
              ...
              <FadeInSection key={item.step} delay={i * 0.15}>
                <div className="relative p-6 rounded-xl bg-[#111827]/60 border border-white/5 text-center group hover:border-[#00d4aa]/20 transition-all duration-300">
                  <span className="text-5xl font-bold text-[#00d4aa]/[0.15] absolute top-3 left-1/2 -translate-x-1/2">
                    {item.step}
                  </span>
                  <div className="pt-10">
      ...
      {/* ===== FEATURES ===== */}
      <section className="py-24 px-6 relative">
        <div className="absolute top-1/2 left-0 w-[500px] h-[500px] bg-[#00d4aa]/[0.03] rounded-full blur-[140px] pointer-events-none -translate-y-1/2" />
